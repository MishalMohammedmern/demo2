  ...
  return (
    <div>
        ...
        <div className='w-full h-968 bg-black pb-20'>
          ...
          <div className=' ml-30% w-849 h-12 absolute top-72 flex flex-row'><input className='font-noto text-lg bg-black rounded-md text-buttoncolor w-full h-full border-buttoncolor pl-4' type="text"  placeholder='Search a Product...|'/>
          ...
          <div className='flex flex-row ml-55% relative bottom-96 '>
            <div className='w-215 h-337 border-buttoncolor rounded-md relative '><img className=' w-full h-full m-0   ' src="/images/img1.png" alt="" /></div>
            <div className='w-215 h-337 border-buttoncolor rounded-md ml-5 relative '><img className=' w-full h-full' src="/images/img2.png" alt="" /></div>
            <div className='w-215 h-337 border-buttoncolor rounded-md ml-5 relative '><img className=' w-full h-full' src="/images/img3.png" alt="" /></div>
          </div>
          <div className=' w-full flex flex-row justify-center absolute bottom-80'>
